...
const TicketRise = () => {
  ...
  return (
    <div className="bg-gradient-to-br from-teal-100 to-cyan-200 min-h-screen p-8">
<div class="grid md:grid-cols-3 items-start gap-4 max-md:gap-12 max-w-8xl max-w-8xl mx-auto py-6 bg-green-100 font-[sans-serif] p-12 mt-36 ">
      <div class="px-4">
